...
public class IlastikTimeListener implements AdjustmentListener {
	final Label label;
	final String string;
	...
	public IlastikTimeListener(final InteractiveImporter parent, final Label label, final String string, final float min, final float max,
	...
	public void adjustmentValueChanged(AdjustmentEvent e) {
		...
		parent.fourthDimension = (int) Math.round(utils.Slicer.computeValueFromScrollbarPosition(e.getValue(), min, max, scrollbarSize));


		deltaScrollbar
		.setValue(utils.Slicer.computeScrollbarPositionFromValue(parent.fourthDimension, min, max, scrollbarSize));
